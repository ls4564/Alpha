...
public class BaseActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        else if (id == R.id.menuCharge) {
            intent = new Intent(this, ChargeActivity.class);
            startActivity(intent);
            return true;
        }
        else if (id == R.id.menuQR_Code_Generator) {
            intent = new Intent(this, QR_Code_Generator.class);
            startActivity(intent);
            return true;
        }
        else if (id == R.id.menuQR_Code_Scanner) {
            intent = new Intent(this, QR_Code_Scanner.class);
            startActivity(intent);
            return true;
        }
